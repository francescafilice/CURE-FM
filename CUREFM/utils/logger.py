...
class Logger:
    ...
    def log_model_summary(self, model_name, model_params, metrics):
        ...
        self.logger.info("=" * (len(model_name) + 16))  
        

    def log_models_metrics_comparison(self, title, metrics_dict, sort_by=None):
        """
