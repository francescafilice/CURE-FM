...
class Code15HuBERTECGPreprocessor(BasePreprocessor):
    ...
    def preprocess(self) -> None:
        ...
        for i in range(self.num_parts):  # TODO: ripristina per processare l'intero dataset
    ...
    def process_metadata(self, hdf5_index: int) -> pd.DataFrame:
        ...
        existing_columns = [col for col in self.labels if col in filtered_df.columns]
