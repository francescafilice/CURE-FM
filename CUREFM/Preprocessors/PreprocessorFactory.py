...
from .NSTEMIECGFMPreprocessor import NSTEMIECGFMPreprocessor
from .NSTEMIHuBERTECGPreprocessor import NSTEMIHuBERTECGPreprocessor
...
class PreprocessorFactory:
    ...
    def create_preprocessor(
        ...
        **kwargs
        ...
        elif dataset_type == 'nstemi':

            if model_type in ['ecg-fm', 'ecgfm', 'ecg_fm']:
                return NSTEMIECGFMPreprocessor(
                    raw_data_path=raw_data_path,
                    processed_data_dir=processed_data_dir,
                    ecg_dataset_path=ecg_dataset_path,
                    meta_dataset_path=meta_dataset_path,
                ...
                return NSTEMIHuBERTECGPreprocessor(
                    raw_data_path=raw_data_path,
                    processed_data_dir=processed_data_dir,
                    ecg_dataset_path=ecg_dataset_path,
                    meta_dataset_path=meta_dataset_path,
