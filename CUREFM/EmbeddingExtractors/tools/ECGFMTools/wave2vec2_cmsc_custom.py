...
from wave2vec2_custom import Wav2Vec2ConfigCustom, Wav2Vec2ModelCustom


@dataclass
class Wav2Vec2CMSCConfigCustom(Wav2Vec2ConfigCustom):
    pass


@register_model("wav2vec2_cmsc_custom", dataclass=Wav2Vec2CMSCConfigCustom)
class Wav2Vec2CMSCModelCustom(Wav2Vec2ModelCustom):
    def __init__(self, cfg: Wav2Vec2CMSCConfigCustom):
        super().__init__(cfg)
        self.cfg = cfg
