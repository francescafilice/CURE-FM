...
@dataclass
class Wav2Vec2ConfigCustom(ECGTransformerConfig):
...
@register_model("wav2vec2custom", dataclass=Wav2Vec2ConfigCustom)
class Wav2Vec2ModelCustom(ECGTransformerModel):
    def __init__(self, cfg: Wav2Vec2ConfigCustom):
        super().__init__(cfg)
        self.cfg = cfg
